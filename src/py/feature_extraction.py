...
def load_args(args=None):
	...
	parser = argparse.ArgumentParser(description='Extract specific block of basenji trained model and add new layers')
...
def build_dense(params, trained_model):
	...
	# build trunk dense
	current = layers.activate(current, 'gelu_dense')
	...
	# build head dense
	current = layers.activate(current, 'gelu_head')
