...
then
	...
	mv wgEncodeHg19ConsensusSignalArtifactRegions.bed data/basenji_data
fi

../../basenji/bin/basenji_data.py -b $blacklist --local -p 8 -r 4096 -w 192 -l 1344 --peaks -v .12 -t .12 --stride 192 --stride_test 192 --crop 576 -o ../../data/basenji_peak $fasta ../../config/targets.txt
