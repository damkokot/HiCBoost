...
basenji/bin/basenji_data.py -b $blacklist -d 0.3 --local -p 8 -r 4096 -w 192 -l 1344 --peaks -v .12 -t .12 --stride 192 --stride_test 192 --crop 576 -o data/basenji_peak/d03_basset_data $fasta config/targets.txt
