...
basenji/bin/basenji_data.py -d .1 -b $blacklist --local -p 8 -r 4096 -w 192 -l 1344 --peaks -v .12 -t .12 --stride 192 --stride_test 192 --crop 576 -o data/basenji_peak/mini_basset_model $fasta config/targets.txt
